...
lp = [
    ...
    Plot("1stjetpt"           , TH1D("1stjetpt"    , ";1st jet p_{T} (GeV);entries/bin", 50, 0., 2000.)),
    Plot("2ndjetpt"           , TH1D("2ndjetpt"    , ";2nd jet p_{T} (GeV);entries/bin", 50, 0., 2000.)),
    Plot("5thjetpt"           , TH1D("5thjetpt"    , ";5th jet p_{T} (GeV);entries/bin", 50, 0., 350.)),
    Plot("6thjetpt"           , TH1D("6thjetpt"    , ";6th jet p_{T} (GeV);entries/bin", 50, 0., 250.)),
    ...
    Plot("HTb"            , TH1D("HTB"     , ";HTB (GeV);entries/bin", 50, 0., 2000.)),
