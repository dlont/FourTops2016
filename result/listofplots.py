...
lp = [
    ...
    Plot("csvJetcsv1"            , TH1D("csvJetcsv1"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv2"            , TH1D("csvJetcsv2"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv3"            , TH1D("csvJetcsv3"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv4"            , TH1D("csvJetcsv4"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt1"            , TH1D("csvJetpt1"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt2"            , TH1D("csvJetpt2"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt3"            , TH1D("csvJetpt3"     , ";CSV;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt4"            , TH1D("csvJetpt4"     , ";CSV;entries/bin", 100, 0., 1.))
    ]
