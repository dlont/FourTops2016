...
lp = [
    ...
    Plot("1stjetpt"           , TH1D("1stjetpt"    , ";p_{T} (GeV);entries/bin", 100, 0., 2000.)),
    Plot("2ndjetpt"           , TH1D("2ndjetpt"    , ";p_{T} (GeV);entries/bin", 100, 0., 2000.)),
    Plot("5thjetpt"           , TH1D("5thjetpt"    , ";p_{T} (GeV);entries/bin", 100, 0., 350.)),
    Plot("6thjetpt"           , TH1D("6thjetpt"    , ";p_{T} (GeV);entries/bin", 100, 0., 250.)),
    Plot("LeptonPt"           , TH1D("leptonpt"    , ";p_{T} (GeV);entries/bin", 100, 0., 1000.)),
    Plot("LeptonEta"           , TH1D("leptoneta"    , ";#eta ;entries/bin", 100, -2.5, 2.5)),
    Plot("leptonphi"           , TH1D("leptonphi"    , ";#eta ;entries/bin", 100, -pi, pi)),
    Plot("leptonIso"           , TH1D("leptonIso"    , ";Isolation ;entries/bin", 100, 0., 0.5)),
    ...
    Plot("HTX"            , TH1D("HTX"     , ";Number of jets;entries/bin", 15, 3.5, 18.5)),
    Plot("SumJetMassX"            , TH1D("SumJetMassX"     , ";M (GeV);entries/bin", 100, 0., 6000.)),
    ...
    Plot("csvJetcsv1"            , TH1D("csvJetcsv1"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv2"            , TH1D("csvJetcsv2"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv3"            , TH1D("csvJetcsv3"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetcsv4"            , TH1D("csvJetcsv4"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt1"            , TH1D("csvJetpt1"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt2"            , TH1D("csvJetpt2"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt3"            , TH1D("csvJetpt3"     , ";Number of events;entries/bin", 100, 0., 1.)),
    Plot("csvJetpt4"            , TH1D("csvJetpt4"     , ";Number of events;entries/bin", 100, 0., 1.))
    ]
