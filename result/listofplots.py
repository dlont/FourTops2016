...
lp = [
    ...
    Plot("jetvec[][0]"           , TH1D("jetpt"    , ";jet p_{T} (GeV);entries/bin", 50, 30., 1500.)),
    ...
    Plot("5thjetpt"           , TH1D("5thjetpt"    , ";5th jet p_{T} (GeV);entries/bin", 50, 30., 250.)),
    Plot("6thjetpt"           , TH1D("6thjetpt"    , ";6th jet p_{T} (GeV);entries/bin", 50, 30., 200.)),
    Plot("LeptonPt"           , TH1D("leptonpt"    , ";Lepton p_{T} (GeV);entries/bin", 50, 0., 1000.)),
    ...
    Plot("nLtags"           , TH1D("nltags"    , ";Number of loose tags;entries/bin", 10, -0.5, 9.5)),
    ...
    Plot("nJets"            , TH1D("njets"     , ";Number of jets;entries/bin", 11, 5.5, 16.5)),
    Plot("HTb"            , TH1D("HTB"     , ";HTB (GeV);entries/bin", 50, 0., 1500.)),
    Plot("HTH"            , TH1D("HTH"     , ";HTH;entries/bin", 100, 0.1, 1.1)),
    Plot("HTRat"            , TH1D("HTRat"     , ";HTRat;entries/bin", 100, 0., 0.45)),
    Plot("HTX"            , TH1D("HTX"     , ";HTX;entries/bin", 50, 0., 3000.)),
    Plot("SumJetMassX"            , TH1D("SumJetMassX"     , ";Sum jet M (GeV);entries/bin", 100, 0., 4000.)),
