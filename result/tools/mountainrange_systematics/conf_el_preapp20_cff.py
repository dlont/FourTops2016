 ...
 'canvas_btag':{
    ...
    "separators":{
     ...
     "central":{
         "type":{         
            "algorithm":"from_file",
            "infile":"/storage_mnt/storage/user/dlontkov/TTP_CMSSW_8_0_26_patch1/src/TopBrussels/FourTops2016/result/prepapproval2.0/plots_el_filt_custombinning_10J4M/Hists_TT_CARDS.root",
