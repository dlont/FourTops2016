config={'annotation': 'Electron channel. Comparison of MC templates with different systematic variations.',
 ...
 'canvas_btag':{
    ...
    "separators":{
         "labels":[["8/2",5.5],["8/3",10.5],["8/4",14.7],["9/2",19.0],["9/3",23.0],["9/4",27.0],["10/2",30.0],["10/3",34.0],["10/4",38.5]],
         "ypos":0.5,
         "size":0.022,
     },
     "central":{
         "type":{         
            "algorithm":"from_file",
            "infile":"/user/dlontkov/t2016/result/final_unblinding/filtered_samples/plots_el_filt_custombinning_10J4M_JERSummer16_v0.0.41_weightbugfix_v2/Hists_TT_CARDS.root",
