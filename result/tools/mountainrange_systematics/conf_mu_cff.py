 ...
 'canvas_btag':{
    ...
    "separators":{
     ...
     "central":{
         "type":{         
            "algorithm":"from_file",
            "infile":"/user/dlontkov/t2016/result/final_unblinding/filtered_samples/plots_mu_filt_custombinning_10J4M_JERSummer16_v0.0.41_weightbugfix//Hists_TT_CARDS.root",
