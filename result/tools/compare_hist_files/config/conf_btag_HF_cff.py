...
'shape_sys':{
	...
	'sources':
		...
		'btagWeightCSVHFStats1':{		
			'up':[bin+'_btagWeightCSVHFStats1Up/bdt' for bin in binlist],		# up variation
			'down':[bin+'_btagWeightCSVHFStats1Down/bdt' for bin in binlist],	# down variation
			'linestyle':2}
		,
		'btagWeightCSVHFStats2':{
			'up':[bin+'_btagWeightCSVHFStats2Up/bdt' for bin in binlist],		# up variation
			'down':[bin+'_btagWeightCSVHFStats2Down/bdt' for bin in binlist],	# down variation
			'linestyle':3}
		,
		'btagWeightCSVHF':{
			'up':[bin+'_btagWeightCSVHFUp/bdt' for bin in binlist],			# up variation
			'down':[bin+'_btagWeightCSVHFDown/bdt' for bin in binlist],		# down variation
			'linestyle':4}
		}
	}
}
