...
<MethodSetup Method="BDT::{mva_name}">
	<GeneralInfo>
		...
		<Info name="Creator" value="smoortga"/>
		...
		<Info name="Dir" value="/user_mnt/user/smoortga/CTag/TMVActag_v1/CTaggingCvsB/CMSSW_7_5_1_Retraining"/>
...
def ada_to_tmva(cls, data, outfile_name, **kwargs):
    # if not isinstance(cls, GradientBoostingRegressor):
    #     raise ValueError("Can only export GradientBoostingRegressor")
    # if cls.loss != "huber":
    #     raise ValueError("TMVA assumes loss=huber")
