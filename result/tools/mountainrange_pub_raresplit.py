...
import mountainrane_pub_style as mrs
...
def main(arguments):
	...
	hist_bg_prefit_unc_noempty = mr.noemptybins(hist_bg_prefit_unc, binmapping)
        ...
        if 'prefit_Rare1TTW' in jsondic: hist_prefit_Rare1TTW_noempty    = mr.fillnonemptysingle(arguments, inputrootfile, jsondic['prefit_Rare1TTW'], 'hist_prefit_Rare1TTW', nbins, binmapping)
