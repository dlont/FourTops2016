...
def trgcuts(tree_name):
	trigger_cuts = ''
	if 'Mu' in tree_name:
	        trigger_cuts = "((HLT_IsoMu24==1||HLT_IsoTkMu24==1) && met > 50 && HT > 500 && fabs(LeptonEta)<2.1 && leptonIso<0.15)"
	        ...
	        trigger_cuts = "((HLT_Ele32_eta2p1_WPTight_Gsf==1) &&  met > 50 && HT > 500 && fabs(LeptonEta)<2.1)"
	        #trigger_cuts = "(HLT_PFHT400_SixJet30_DoubleBTagCSV_p056==1)"
