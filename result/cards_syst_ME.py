...
def getMECutSets(syst,cut_string,search_scheme='9J3M,10J3M'):
    cut_sets = [
        #central
        ("allSF_{0}Up".format(syst), "inclusive",  "(1 {0})*{1}*Max$(abs(weight))".format(cut_string,centralweight)),
        ("allSF_{0}Down".format(syst), "inclusive",  "(1 {0})*{1}*Min$(abs(weight))".format(cut_string,centralweight)),
