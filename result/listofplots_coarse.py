...
def lp(treename,filename,target):
	...
	Plot("jetvec[][0]"           , TH1D("jetpt"    , ";jet p_{T} (GeV);entries/bin", 5, 30., 1500.)),
	Plot("jetvec[][1]"           , TH1D("jeteta"    , ";jet #eta;entries/bin", 10, -2.5, 2.5)),
	Plot("jetvec[][2]"           , TH1D("jetphi"    , ";jet #phi;entries/bin", 10, -pi, pi)),
	Plot("jetvec[][3]"           , TH1D("jetcsv"    , ";jet CSVv2;entries/bin", 20, 0., 1.)),
	Plot("1stjetpt"           , TH1D("1stjetpt"    , ";1st jet p_{T} (GeV);entries/bin", 5, 0., 1500.)),
	Plot("2ndjetpt"           , TH1D("2ndjetpt"    , ";2nd jet p_{T} (GeV);entries/bin", 5, 0., 1000.)),
	Plot("5thjetpt"           , TH1D("5thjetpt"    , ";5th jet p_{T} (GeV);entries/bin", 5, 30., 250.)),
	Plot("6thjetpt"           , TH1D("6thjetpt"    , ";6th jet p_{T} (GeV);entries/bin", 5, 30., 200.)),
	Plot("LeptonPt"           , TH1D("leptonpt"    , ";Lepton p_{T} (GeV);entries/bin", 5, 0., 800.)),
	Plot("LeptonEta"           , TH1D("leptoneta"    , ";Lepton #eta ;entries/bin", 5, -2.5, 2.5)),
	Plot("leptonphi"           , TH1D("leptonphi"    , ";Lepton #phi ;entries/bin", 5, -pi, pi)),
	Plot("leptonIso"           , TH1D("leptonIso"    , ";Lepton Isolation ;entries/bin", 5, 0., isorangemax)),
	...
	Plot("HT"           , TH1D("ht"    , ";HT (GeV);entries/bin", 5, 150., 2000.)),
	Plot("HTb"            , TH1D("HTB"     , ";HTB (GeV);entries/bin", 5, 0., 1000.)),
	Plot("HTH"            , TH1D("HTH"     , ";HTH;entries/bin", 5, 0.1, 1.1)),
	Plot("HTRat"            , TH1D("HTRat"     , ";HTRat;entries/bin", 5, 0., 0.45)),
	Plot("HTX"            , TH1D("HTX"     , ";HTX (GeV);entries/bin", 5, 0., 3000.)),
	Plot("SumJetMassX"            , TH1D("SumJetMassX"     , ";Sum jet M (GeV);entries/bin", 5, 0., 3500.)),
	Plot("PU"           , TH1D("pu"    , ";Number of prim. v.;entries/bin", 55, -0.5, 54.5)),
	Plot("NjetsW"           , TH1D("njetsw"    , ";p_{T} weighted jet multiplicity;entries/bin", 5, -0.5, 15.5)),
	...
	Plot("met"            , TH1D("met"     , ";MET (GeV);entries/bin", 5, 0., 400.)),
	#Plot("csvJetcsv1"            , TH1D("csvJetcsv1"     , ";CSV1;entries/bin", 100, 0., 1.)),
	#Plot("csvJetcsv2"            , TH1D("csvJetcsv2"     , ";CSV2;entries/bin", 100, 0., 1.)),
	Plot("csvJetcsv3"            , TH1D("csvJetcsv3"     , ";CSV3;entries/bin", 20, 0., 1.)),
	Plot("csvJetcsv4"            , TH1D("csvJetcsv4"     , ";CSV4;entries/bin", 20, 0., 1.)),
