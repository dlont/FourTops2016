...
cut_sets = [
    ...
    #central
    ("6J2M", "Njet=6, nMtags=2",  "(nJets==6 && nMtags==2)*ScaleFactor*SFPU/SFPU_down"),
    ("6J3M", "Njet=6, nMtags=3",  "(nJets==6 && nMtags==3)*ScaleFactor*SFPU/SFPU_down"),
    ("6J4M", "Njet=6, nMtags=4",  "(nJets==6 && nMtags==4)*ScaleFactor*SFPU/SFPU_down"),
    ("7J2M", "Njet=7, nMtags=2",  "(nJets==7 && nMtags==2)*ScaleFactor*SFPU/SFPU_down"),
    ("7J3M", "Njet=7, nMtags=3",  "(nJets==7 && nMtags==3)*ScaleFactor*SFPU/SFPU_down"),
    ("7J4M", "Njet=7, nMtags=4",  "(nJets==7 && nMtags==4)*ScaleFactor*SFPU/SFPU_down"),
    ("8J2M", "Njet=8, nMtags=2",  "(nJets==8 && nMtags==2)*ScaleFactor*SFPU/SFPU_down"),
    ("8J3M", "Njet=8, nMtags=3",  "(nJets==8 && nMtags==3)*ScaleFactor*SFPU/SFPU_down"),
    ("8J4M", "Njet=8, nMtags=4",  "(nJets==8 && nMtags==4)*ScaleFactor*SFPU/SFPU_down"),
    ("9J2M", "Njet=9+, nMtags=2", "(nJets>=9 && nMtags==2)*ScaleFactor*SFPU/SFPU_down"),
    ("9J3M", "Njet=9+, nMtags=3", "(nJets>=9 && nMtags==3)*ScaleFactor*SFPU/SFPU_down"),
    ("9J4M", "Njet=9+, nMtags=4", "(nJets>=9 && nMtags==4)*ScaleFactor*SFPU/SFPU_down"),
    #PU UP
    ("6J2M_PUUp", "Njet=6, nMtags=2",  "(nJets==6 && nMtags==2)*ScaleFactor*SFPU_up/SFPU_down"),
    ("6J3M_PUUp", "Njet=6, nMtags=3",  "(nJets==6 && nMtags==3)*ScaleFactor*SFPU_up/SFPU_down"),
    ("6J4M_PUUp", "Njet=6, nMtags=4",  "(nJets==6 && nMtags==4)*ScaleFactor*SFPU_up/SFPU_down"),
    ("7J2M_PUUp", "Njet=7, nMtags=2",  "(nJets==7 && nMtags==2)*ScaleFactor*SFPU_up/SFPU_down"),
    ("7J3M_PUUp", "Njet=7, nMtags=3",  "(nJets==7 && nMtags==3)*ScaleFactor*SFPU_up/SFPU_down"),
    ("7J4M_PUUp", "Njet=7, nMtags=4",  "(nJets==7 && nMtags==4)*ScaleFactor*SFPU_up/SFPU_down"),
    ("8J2M_PUUp", "Njet=8, nMtags=2",  "(nJets==8 && nMtags==2)*ScaleFactor*SFPU_up/SFPU_down"),
    ("8J3M_PUUp", "Njet=8, nMtags=3",  "(nJets==8 && nMtags==3)*ScaleFactor*SFPU_up/SFPU_down"),
    ("8J4M_PUUp", "Njet=8, nMtags=4",  "(nJets==8 && nMtags==4)*ScaleFactor*SFPU_up/SFPU_down"),
    ("9J2M_PUUp", "Njet=9+, nMtags=2", "(nJets>=9 && nMtags==2)*ScaleFactor*SFPU_up/SFPU_down"),
    ("9J3M_PUUp", "Njet=9+, nMtags=3", "(nJets>=9 && nMtags==3)*ScaleFactor*SFPU_up/SFPU_down"),
    ("9J4M_PUUp", "Njet=9+, nMtags=4", "(nJets>=9 && nMtags==4)*ScaleFactor*SFPU_up/SFPU_down"),
    #PU DOWN
    ("6J2M_PUDown", "Njet=6, nMtags=2",  "(nJets==6 && nMtags==2)*ScaleFactor"),
    ("6J3M_PUDown", "Njet=6, nMtags=3",  "(nJets==6 && nMtags==3)*ScaleFactor"),
    ("6J4M_PUDown", "Njet=6, nMtags=4",  "(nJets==6 && nMtags==4)*ScaleFactor"),
    ("7J2M_PUDown", "Njet=7, nMtags=2",  "(nJets==7 && nMtags==2)*ScaleFactor"),
    ("7J3M_PUDown", "Njet=7, nMtags=3",  "(nJets==7 && nMtags==3)*ScaleFactor"),
    ("7J4M_PUDown", "Njet=7, nMtags=4",  "(nJets==7 && nMtags==4)*ScaleFactor"),
    ("8J2M_PUDown", "Njet=8, nMtags=2",  "(nJets==8 && nMtags==2)*ScaleFactor"),
    ("8J3M_PUDown", "Njet=8, nMtags=3",  "(nJets==8 && nMtags==3)*ScaleFactor"),
    ("8J4M_PUDown", "Njet=8, nMtags=4",  "(nJets==8 && nMtags==4)*ScaleFactor"),
    ("9J2M_PUDown", "Njet=9+, nMtags=2", "(nJets>=9 && nMtags==2)*ScaleFactor"),
    ("9J3M_PUDown", "Njet=9+, nMtags=3", "(nJets>=9 && nMtags==3)*ScaleFactor"),
    ("9J4M_PUDown", "Njet=9+, nMtags=4", "(nJets>=9 && nMtags==4)*ScaleFactor"),
    #Scale variations
