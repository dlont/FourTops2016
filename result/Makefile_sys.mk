...
combinechecks: card_mu.txt card_el.txt datacard_elmu.txt
	...
	@combine -M MaxLikelihoodFit -t -1 --expectSignal 0 --robustFit=true $(MINOS) --out cards_el card_el.txt -n _AsymovMu0
	@python $(DIFFNUIS) --absolute -a cards_el/mlfit_AsymovEl0.root -g cards_el/plots_AsymovEl0.root
	@combine -M MaxLikelihoodFit -t -1 --expectSignal 1 --robustFit=true $(MINOS) --out cards_el card_el.txt -n _AsymovMu1
