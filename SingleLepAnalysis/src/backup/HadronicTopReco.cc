...
HadronicTopReco::HadronicTopReco(const TString& trainfilename, bool isMuon, bool isElectron, bool TrainMVA, vector < Dataset* > datasets, string MVAmethodIn, bool isdebug, float Lumi):
	debug(false),
	leptonChoice(""),
	...
	jetCombiner(new JetCombiner(TrainMVA, Lumi, datasets, MVAmethodIn, false, "",trainfilename.Data(),"_13TeV" )), //_13TeV in last arg for 13tev training
	bestTopMass1(0),
	bestTopMass2(0),
