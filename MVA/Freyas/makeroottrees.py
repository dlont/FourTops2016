...
#infilename='./Craneen_ttttNLO_Run2_TopTree_Study.root'
infilename='./Craneen_TTJets_powheg_Run2_TopTree_Study.root'
#outfilename='./Craneen_ttttNLO_Run2_TopTree_Study_newMVA.root'
outfilename='./Craneen_TTJets_powheg_Run2_TopTree_Study_newMVA.root'
